...
namespace FIPE
{
    public class FIPEBLL
    {
        ...
        {
            var client = new RestClient("http://fipeapi.appspot.com/");
            var req = new RestRequest("api/1/{tipo}/marcas.json");
        ...
        {
            var client = new RestClient("http://fipeapi.appspot.com/");
            var req = new RestRequest("api/1/{tipo}/veiculos/{id}.json");
            req.AddParameter("tipo", tipo, ParameterType.UrlSegment);
        ...
        {
            var client = new RestClient("http://fipeapi.appspot.com/");
            var req = new RestRequest("api/1/{tipo}/veiculo/{id}/{idC}.json");
            req.AddParameter("tipo", tipo, ParameterType.UrlSegment);
            req.AddParameter("id", idMarca, ParameterType.UrlSegment);
        ...
        {
            var client = new RestClient("http://fipeapi.appspot.com/");
            var req = new RestRequest("api/1/{tipo}/veiculo/{id}/{idC}/{idA}.json");
            req.AddParameter("tipo", tipo, ParameterType.UrlSegment);
            req.AddParameter("id", idMarca, ParameterType.UrlSegment);
            req.AddParameter("idC", idCarro, ParameterType.UrlSegment);
